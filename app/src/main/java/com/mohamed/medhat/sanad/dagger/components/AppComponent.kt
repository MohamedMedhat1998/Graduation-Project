...
import com.mohamed.medhat.sanad.dagger.modules.ChatModule
 ...
 */
@Singleton
@Component(modules = [AppSubcomponentsModule::class, NetworkModule::class, SharedPreferencesModule::class, ChatModule::class])
